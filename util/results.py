...
def save_and_plot(results: dict[str, DataFrame], df_mod_fn: Callable[[DataFrame], DataFrame] = None, plot_fn: Callable[[str, str, DataFrame], None] = None, dir: str = 'results') -> None:
    """
